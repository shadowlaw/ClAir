...
def upgrade():
    ...
    op.create_table('permit_area_pollutant',
    sa.Column('permit_id', sa.String(length=100), nullable=False),
    ...
    sa.PrimaryKeyConstraint('permit_id', 'pollutant_id')
    )
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('permit_area_pollutant')
